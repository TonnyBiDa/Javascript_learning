export var Tony = document.getElementById("Tony");
export var Mitch = document.getElementById("Mitch");
export var Anna = document.getElementById("Anna");
...
export var items = document.querySelectorAll("li");

export var inputs = document.querySelectorAll("input");
